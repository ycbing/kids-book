...
基于人工智能的儿童绘本创作平台，提供完整的绘本生成、管理和导出功能。
...
如有问题，请访问 [GitHub Issues](https://github.com/your-repo/issues) 或联系技术支持。
""",
    version="1.0.0",
    lifespan=lifespan,
    contact={
    ...
    openapi_tags=[
        {
            "name": "健康检查",
            "description": "服务健康状态检查接口，用于监控和负载均衡器探测"
        },
        {
            "name": "用户认证",
            "description": "用户注册、登录、token刷新等认证相关接口"
        },
        {
            "name": "绘本管理",
            "description": "绘本的创建、查询、更新、删除等管理操作"
        },
        {
            "name": "图片生成",
            "description": "AI图片生成相关接口，支持多种艺术风格"
        },
        {
            "name": "导出功能",
            "description": "绘本导出为PDF或图片的功能"
        }
    ],
    docs_url="/docs",
    redoc_url="/redoc"
